...
while(error_code AND number_of_tries LESS 3)
  execute_process(
    COMMAND "/usr/bin/git"
            clone --no-checkout --config "advice.detachedHead=false" "https://gitee.com/openharmony/third_party_spdlog.git" "spdlog"
...
if(error_code)
  message(FATAL_ERROR "Failed to clone repository: 'https://gitee.com/openharmony/third_party_spdlog.git'")
endif()
